	...
	public partial class AddStudent : UserControl
    {
                ...
                if(connect.State == ConnectionState.Closed)
                {
                    try
                    {
                        ...
                        using(SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                          ...
                          //  E:\New folder\Employee - Management - System -in-CSharp - main\StudentRegistrationSystem\EmployeeManagementSystem\Directory\
                                string path = Path.Combine(@"E:\New folder\Employee-Management-System-in-CSharp-main\StudentRegistrationSystem\EmployeeManagementSystem\Directory\"
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if(e.RowIndex != -1)
            {
                ...
                addStudent_id.Text = row.Cells[0].Value.ToString();
                ...
                addStudent_status.Text = row.Cells[7].Value.ToString();
